...
<div class="footerSection">
	<div class="logo">
		<img src="resources/images/Mathified-Logo.jpg" class="logoImg"/>
	</div>
	<div class="social">
        <a href="https://www.facebook.com/" class="facebook socialLink" target="_blank">
        ...
        <a href="https://twitter.com/" class="twitter socialLink" target="_blank">
        ...
        <a href="https://www.linkedin.com/" class="linkedin socialLink" target="_blank">
...
<div class="footerSection">
<div class="footerSectionHeader">About us</div>
<div>Our moto is simple:</div>
<div>Math + Simplified = Mathified!</div>
</div>
<div class="rightsReserved">Copyright © 2017 All Rights Reserved</div>
</div>
